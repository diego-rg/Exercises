...
app.use(express.static(path.join(__dirname, "public")));//preparar para enviar css, js etc. Pódese facer 1 carpeta public con todo ou varias: app.use(express.static("css")); ...ic("js")); etc
//Despois poñer o link no archivo ejs correspondente
