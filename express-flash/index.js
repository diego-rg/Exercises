...
const flash = require("connect-flash");//Todos as req teñen .flash() para crear mensaxes flash (mensaxes temporales creados despois dunha reqquest)
...
//Uso de middleware para pasar os messages de flash
...
app.get("/farms", async (req, res) =>{
    ...
    res.render("farms/index", { farms }); //con messages: req.flash("success") });//Punto onde se mostra o flash. Hai que añadilo no template correspondente de ejs. Non fai falta se usas o middle
})
...
app.post("/farms", async (req, res) => {
    ...
    await newFarm.save();
    console.log(newFarm);
    req.flash("success", "New farm saved!");//Punto no que se crea o flash
    res.redirect("farms")
})
